...
-- los demas inserts (alquiler y pagos) no se pudieron ejecutar, ya que el alquiler contiene mas de 400 clientes en el cual yo tengo menos de eso, a su vez, si pongo mas clientes las direcciones me tiraran un error.
